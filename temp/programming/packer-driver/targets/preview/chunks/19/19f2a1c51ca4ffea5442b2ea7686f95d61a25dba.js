System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Sprite, Image, MovieClip, _crd;

  function _reportPossibleCrUseOfImage(extras) {
    _reporterNs.report("Image", "./Image", _context.meta, extras);
  }

  _export("MovieClip", void 0);
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "e7114Z2QhBMs5/O4n4D/Qrm", "MovieClip", undefined);

      __checkObsolete__(['Rect', 'Sprite', 'SpriteFrame']);

      _export("MovieClip", MovieClip = class MovieClip extends (_crd && Image === void 0 ? (_reportPossibleCrUseOfImage({
        error: Error()
      }), Image) : Image) {
...
//# sourceMappingURL=19f2a1c51ca4ffea5442b2ea7686f95d61a25dba.js.map
    ...
    execute: function () {
      ...
      _export("GameHUDController", GameHUDController = class GameHUDController extends (_crd && ScreenBase === void 0 ? (_reportPossibleCrUseOfScreenBase({
        ...
        constructor(packageName, game, audio, scores, misses) {
          ...
          this.scores = scores;
          this.misses = misses;
          var pauseButton = (_this$view$getChild = this.view.getChild("PauseButton")) == null ? void 0 : _this$view$getChild.asButton;
          var inputButton = (_this$view$getChild2 = this.view.getChild("InputButton")) == null ? void 0 : _this$view$getChild2.asButton;
          ...
          var missedItems = (_this$view$getChild7 = this.view.getChild("MissedItems")) == null ? void 0 : _this$view$getChild7.asCom;
...
//# sourceMappingURL=cd8c16f0edddfe784abfe92bbfd96cc8800e9e35.js.map
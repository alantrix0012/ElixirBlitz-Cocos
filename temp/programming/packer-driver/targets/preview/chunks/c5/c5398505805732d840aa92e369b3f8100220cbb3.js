  ...
  return {
    ...
    execute: function () {
      ...
      _export("UIManager", UIManager = (_dec = ccclass("UIManager"), _dec2 = property(_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
        ...
        loadUIPackage() {
          fgui.UIPackage.loadPackage(this.packageAssetPath, fgui.Handler.create(this, this.onPackageLoaded));
        }
...
//# sourceMappingURL=c5398505805732d840aa92e369b3f8100220cbb3.js.map
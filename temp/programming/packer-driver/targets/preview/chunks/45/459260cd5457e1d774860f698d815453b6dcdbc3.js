    ...
    execute: function () {
      ...
      _export("GameHUDController", GameHUDController = class GameHUDController extends (_crd && ScreenBase === void 0 ? (_reportPossibleCrUseOfScreenBase({
        ...
        constructor(packageName, game, audio, scores, misses) {
          ...
          this.scores = scores;
          this.misses = misses;
          var pauseButton = this.view.getChild("PauseButton").asButton;
          var inputButton = this.view.getChild("InputButton").asButton;
          this.scoreText = this.view.getChild("ScoreText").asTextField;
          this.countDownText = this.view.getChild("CountDownText").asTextField;
          var missedItems = this.view.getChild("MissedItems").asCom;
          this.miss1 = missedItems.getChild("1").asLoader;
          this.miss2 = missedItems.getChild("2").asLoader;
          this.miss3 = missedItems.getChild("3").asLoader;
...
//# sourceMappingURL=459260cd5457e1d774860f698d815453b6dcdbc3.js.map
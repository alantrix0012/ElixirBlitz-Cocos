  ...
  return {
    ...
    execute: function () {
      ...
      _export("MainMenuController", MainMenuController = class MainMenuController extends (_crd && ScreenBase === void 0 ? (_reportPossibleCrUseOfScreenBase({
        ...
        init() {
          var playBtn = this.view.getChild("PlayButton").asButton;
          var settingsBtn = this.view.getChild("SettingsButton").asButton;
          var leaderboardBtn = this.view.getChild("LeaderboardButton").asButton;
...
//# sourceMappingURL=333bb979c0981dc218385b1ea60187ff1d40a56c.js.map
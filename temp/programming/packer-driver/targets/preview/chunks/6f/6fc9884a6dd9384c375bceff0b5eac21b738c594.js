      ...
      _export("Transition", Transition = class Transition {
        ...
        applyValue(item) {
          ...
          switch (item.type) {
            ...
            case ActionType.Color:
              var color = item.target.getProp((_crd && ObjectPropID === void 0 ? (_reportPossibleCrUseOfObjectPropID({
                error: Error()
...
//# sourceMappingURL=6fc9884a6dd9384c375bceff0b5eac21b738c594.js.map
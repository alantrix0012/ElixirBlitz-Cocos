  ...
  return {
    ...
    execute: function () {
      ...
      _export("PausePanelController", PausePanelController = class PausePanelController extends (_crd && ScreenBase === void 0 ? (_reportPossibleCrUseOfScreenBase({
        ...
        init() {
          var playButton = this.popup.getChild("PlayButton");
          var homeButton = this.popup.getChild("HomeButton");
          var retryButton = this.popup.getChild("RetryButton");
...
//# sourceMappingURL=e3f3731415563645c8d92db2a8dc378d8b38230c.js.map
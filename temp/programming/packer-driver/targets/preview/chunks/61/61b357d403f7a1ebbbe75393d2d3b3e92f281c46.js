      ...
      _export("GTextField", GTextField = class GTextField extends (_crd && GObject === void 0 ? (_reportPossibleCrUseOfGObject({
        ...
        set font(value) {
          if (this._font != value || !value) {
            this._font = value;
            this.markSizeChanged();
            var newFont = value ? value : (_crd && UIConfig === void 0 ? (_reportPossibleCrUseOfUIConfig({
              error: Error()
        ...
        assignFont(label, value) {
          if (value instanceof Font) label.font = value;else {
            var font = (_crd && getFontByName === void 0 ? (_reportPossibleCrUseOfgetFontByName({
              error: Error()
...
//# sourceMappingURL=61b357d403f7a1ebbbe75393d2d3b3e92f281c46.js.map
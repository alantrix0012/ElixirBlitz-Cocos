System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, FUIEvent, RelationType, RelationItem, RelationDef, _crd;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "038d7UD6TNB+5rcsSnwSc9y", "RelationItem", undefined);

      _export("RelationItem", RelationItem = class RelationItem {
        constructor(owner) {
          this._owner = void 0;
          this._target = void 0;
          this._defs = void 0;
          this._targetX = void 0;
          this._targetY = void 0;
        ...
        add(relationType, usePercent) {
          if (relationType == (_crd && RelationType === void 0 ? (_reportPossibleCrUseOfRelationType({
            error: Error()
          }), RelationType) : RelationType).Size) {
            this.add((_crd && RelationType === void 0 ? (_reportPossibleCrUseOfRelationType({
              error: Error()
            }), RelationType) : RelationType).Width, usePercent);
            this.add((_crd && RelationType === void 0 ? (_reportPossibleCrUseOfRelationType({
              error: Error()
            }), RelationType) : RelationType).Height, usePercent);
            return;
          }
        ...
        internalAdd(relationType, usePercent) {
          if (relationType == (_crd && RelationType === void 0 ? (_reportPossibleCrUseOfRelationType({
            ...
            this.internalAdd((_crd && RelationType === void 0 ? (_reportPossibleCrUseOfRelationType({
              error: Error()
            }), RelationType) : RelationType).Width, usePercent);
            this.internalAdd((_crd && RelationType === void 0 ? (_reportPossibleCrUseOfRelationType({
              error: Error()
          ...
          info.axis = relationType <= (_crd && RelationType === void 0 ? (_reportPossibleCrUseOfRelationType({
            error: Error()
          }), RelationType) : RelationType).Right_Right || relationType == (_crd && RelationType === void 0 ? (_reportPossibleCrUseOfRelationType({
            error: Error()
          }), RelationType) : RelationType).Width || relationType >= (_crd && RelationType === void 0 ? (_reportPossibleCrUseOfRelationType({
            error: Error()
          }), RelationType) : RelationType).LeftExt_Left && relationType <= (_crd && RelationType === void 0 ? (_reportPossibleCrUseOfRelationType({
            error: Error()
          }), RelationType) : RelationType).RightExt_Right ? 0 : 1;
        ...
        remove(relationType) {
          if (relationType == (_crd && RelationType === void 0 ? (_reportPossibleCrUseOfRelationType({
            ...
            this.remove((_crd && RelationType === void 0 ? (_reportPossibleCrUseOfRelationType({
              error: Error()
        ...
        applyOnSelfResized(dWidth, dHeight, applyPivot) {
          ...
          for (var i = 0; i < length; i++) {
            ...
            switch (info.type) {
              case (_crd && RelationType === void 0 ? (_reportPossibleCrUseOfRelationType({
                error: Error()
              ...
              case (_crd && RelationType === void 0 ? (_reportPossibleCrUseOfRelationType({
                error: Error()
              }), RelationType) : RelationType).Right_Left:
              case (_crd && RelationType === void 0 ? (_reportPossibleCrUseOfRelationType({
                error: Error()
              }), RelationType) : RelationType).Right_Right:
              ...
              case (_crd && RelationType === void 0 ? (_reportPossibleCrUseOfRelationType({
                error: Error()
              }), RelationType) : RelationType).Bottom_Top:
              case (_crd && RelationType === void 0 ? (_reportPossibleCrUseOfRelationType({
                error: Error()
              }), RelationType) : RelationType).Bottom_Bottom:
        ...
        applyOnXYChanged(info, dx, dy) {
          ...
          switch (info.type) {
            ...
            case (_crd && RelationType === void 0 ? (_reportPossibleCrUseOfRelationType({
              error: Error()
            }), RelationType) : RelationType).Left_Right:
            case (_crd && RelationType === void 0 ? (_reportPossibleCrUseOfRelationType({
              error: Error()
            }), RelationType) : RelationType).Center_Center:
            case (_crd && RelationType === void 0 ? (_reportPossibleCrUseOfRelationType({
            ...
            case (_crd && RelationType === void 0 ? (_reportPossibleCrUseOfRelationType({
              error: Error()
            }), RelationType) : RelationType).Top_Top:
            case (_crd && RelationType === void 0 ? (_reportPossibleCrUseOfRelationType({
              error: Error()
            }), RelationType) : RelationType).Top_Middle:
            case (_crd && RelationType === void 0 ? (_reportPossibleCrUseOfRelationType({
              error: Error()
            }), RelationType) : RelationType).Top_Bottom:
            case (_crd && RelationType === void 0 ? (_reportPossibleCrUseOfRelationType({
              error: Error()
            }), RelationType) : RelationType).Middle_Middle:
            case (_crd && RelationType === void 0 ? (_reportPossibleCrUseOfRelationType({
            ...
            case (_crd && RelationType === void 0 ? (_reportPossibleCrUseOfRelationType({
              error: Error()
            }), RelationType) : RelationType).LeftExt_Left:
            case (_crd && RelationType === void 0 ? (_reportPossibleCrUseOfRelationType({
              error: Error()
            }), RelationType) : RelationType).LeftExt_Right:
            ...
            case (_crd && RelationType === void 0 ? (_reportPossibleCrUseOfRelationType({
              error: Error()
            }), RelationType) : RelationType).RightExt_Right:
              if (this._owner != this._target.parent) {
                tmp = this._owner.xMin;
                this._owner.width = this._owner._rawWidth + dx;
            ...
            case (_crd && RelationType === void 0 ? (_reportPossibleCrUseOfRelationType({
              error: Error()
            }), RelationType) : RelationType).TopExt_Top:
            case (_crd && RelationType === void 0 ? (_reportPossibleCrUseOfRelationType({
              error: Error()
            }), RelationType) : RelationType).TopExt_Bottom:
              if (this._owner != this._target.parent) {
            ...
            case (_crd && RelationType === void 0 ? (_reportPossibleCrUseOfRelationType({
              error: Error()
            }), RelationType) : RelationType).BottomExt_Top:
            case (_crd && RelationType === void 0 ? (_reportPossibleCrUseOfRelationType({
              error: Error()
            }), RelationType) : RelationType).BottomExt_Bottom:
              if (this._owner != this._target.parent) {
                tmp = this._owner.yMin;
                this._owner.height = this._owner._rawHeight + dy;
        ...
        addRefTarget(target) {
          if (target != this._owner.parent) target.on((_crd && FUIEvent === void 0 ? (_reportPossibleCrUseOfFUIEvent({
            error: Error()
          }), FUIEvent) : FUIEvent).XY_CHANGED, this.__targetXYChanged, this);
          target.on((_crd && FUIEvent === void 0 ? (_reportPossibleCrUseOfFUIEvent({
            error: Error()
          }), FUIEvent) : FUIEvent).SIZE_CHANGED, this.__targetSizeChanged, this);
          target.on((_crd && FUIEvent === void 0 ? (_reportPossibleCrUseOfFUIEvent({
            error: Error()
          }), FUIEvent) : FUIEvent).SIZE_DELAY_CHANGE, this.__targetSizeWillChange, this);
        ...
        releaseRefTarget(target) {
          ...
          target.off((_crd && FUIEvent === void 0 ? (_reportPossibleCrUseOfFUIEvent({
            error: Error()
          }), FUIEvent) : FUIEvent).XY_CHANGED, this.__targetXYChanged, this);
          target.off((_crd && FUIEvent === void 0 ? (_reportPossibleCrUseOfFUIEvent({
            error: Error()
      ...
      _export("RelationDef", RelationDef = class RelationDef {
        constructor() {
          this.percent = false;
          this.type = 0;
          this.axis = 0;
...
//# sourceMappingURL=4bdca66da30b9d84f3a98df348875e49c200aba4.js.map
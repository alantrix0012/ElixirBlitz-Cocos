System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, fgui, _decorator, Component, view, GameManager, GameState, ScoreManager, UIPanelType, NullAudioBridge, NullVolumeBridge, MainMenuController, SettingsController, LeaderboardPanelController, GameHUDController, PausePanelController, GameOverController, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _class3, _crd, ccclass, property, UIManager;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("UIManager", UIManager = (_dec = ccclass("UIManager"), _dec2 = property(_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
          ...
          this.onGameStateChanged = state => {
            switch (state) {
              ...
              case (_crd && GameState === void 0 ? (_reportPossibleCrUseOfGameState({
                ...
                this.show((_crd && UIPanelType === void 0 ? (_reportPossibleCrUseOfUIPanelType({
                  error: Error()
                }), UIPanelType) : UIPanelType).GameHUDPanel);
                return;
        ...
        loadUIPackage() {
          fgui.UIPackage.loadPackage(this.packageAssetPath, err => {
            if (err) {
              console.error("UIManager: failed to load FairyGUI package at '" + this.packageAssetPath + "': " + err);
              console.error("UIManager: Ensure the package is under assets/resources and was published with the 'Cocos Creator' target.");
              return;
            }
        ...
        onDestroy() {
          ...
          (_this$gameManager = this.gameManager) == null ? void 0 : _this$gameManager.offStateChanged(this.onGameStateChanged);
        }
        ...
        registerScreens() {
          ...
          this.screens.set((_crd && UIPanelType === void 0 ? (_reportPossibleCrUseOfUIPanelType({
            ...
            error: Error()
          }), GameHUDController) : GameHUDController)(this.packageName, gameActions, this.audio, scoreActions, missActions));
          this.screens.set((_crd && UIPanelType === void 0 ? (_reportPossibleCrUseOfUIPanelType({
            error: Error()
...
//# sourceMappingURL=6e77aee5b744ec49e4f8396096bfd6043c5323b8.js.map
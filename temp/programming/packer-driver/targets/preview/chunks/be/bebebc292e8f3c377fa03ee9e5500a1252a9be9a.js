    ...
    execute: function () {
      ...
      _export("SettingsController", SettingsController = class SettingsController extends (_crd && ScreenBase === void 0 ? (_reportPossibleCrUseOfScreenBase({
        ...
        constructor(packageName, ui, audio, volumes) {
          ...
          this.mainVolSlider = this.popup.getChild("MainVolSlider").asSlider;
          this.musicSlider = this.popup.getChild("MusicVolSlider").asSlider;
          this.sfxSlider = this.popup.getChild("SFXVolSlider").asSlider;
          this.init();
        }
        ...
        init() {
          var backBtn = this.popup.getChild("BackButton").asButton;
...
//# sourceMappingURL=bebebc292e8f3c377fa03ee9e5500a1252a9be9a.js.map
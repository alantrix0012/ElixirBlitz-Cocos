System.register(["__unresolved_0", "cc", "fairygui-cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10"], function (_export, _context) {
  "use strict";

  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, view, fgui, GameManager, ScoreManager, UIPanelType, NullAudioBridge, NullVolumeBridge, MainMenuController, SettingsController, LeaderboardPanelController, GameHUDController, PausePanelController, GameOverController, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _class3, _crd, ccclass, property, UIManager;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      NullAudioBridge = _unresolved_5.NullAudioBridge;
      NullVolumeBridge = _unresolved_5.NullVolumeBridge;
    }, function (_unresolved_6) {
      MainMenuController = _unresolved_6.MainMenuController;
    }, function (_unresolved_7) {
      SettingsController = _unresolved_7.SettingsController;
    }, function (_unresolved_8) {
      LeaderboardPanelController = _unresolved_8.LeaderboardPanelController;
    }, function (_unresolved_9) {
      GameHUDController = _unresolved_9.GameHUDController;
    }, function (_unresolved_10) {
      PausePanelController = _unresolved_10.PausePanelController;
    }, function (_unresolved_11) {
      GameOverController = _unresolved_11.GameOverController;
    }],
    execute: function () {
      _crd = true;
      ...
      __checkObsolete__(['_decorator', 'Component', 'view']);
      ...
      _export("UIManager", UIManager = (_dec = ccclass("UIManager"), _dec2 = property(_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
        ...
        show(type) {
          ...
          var next = this.screens.get(type);
          if (!next) return;
...
//# sourceMappingURL=fa0aea72a6cb033ca9261bed4a465f907e1df3f7.js.map
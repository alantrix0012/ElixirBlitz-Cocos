System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Component, director, game, isValid, Mask, math, Node, Rect, screen, sys, UITransform, Vec2, FUIEvent, ScrollBarDisplayType, ScrollType, Decls, GObject, Margin, GTween, UIConfig, UIPackage, ScrollPane, _crd, _gestureFlag, TWEEN_TIME_GO, TWEEN_TIME_DEFAULT, PULL_RATIO, s_vec2, s_rect, sEndPos, sOldChange;
  ...
  function _reportPossibleCrUseOfScrollType(extras) {
    _reporterNs.report("ScrollType", "./FieldTypes", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      ScrollBarDisplayType = _unresolved_3.ScrollBarDisplayType;
      ScrollType = _unresolved_3.ScrollType;
    }, function (_unresolved_4) {
      Decls = _unresolved_4.Decls;
      GObject = _unresolved_4.GObject;
    }, function (_unresolved_5) {
      Margin = _unresolved_5.Margin;
    }, function (_unresolved_6) {
      GTween = _unresolved_6.GTween;
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "88704tt389AxrjK/i877kmZ", "ScrollPane", undefined);

      __checkObsolete__(['Component', 'director', 'game', 'isValid', 'Mask', 'math', 'Node', 'Rect', 'screen', 'sys', 'UITransform', 'Vec2', 'View']);
      ...
      _export("ScrollPane", ScrollPane = class ScrollPane extends Component {
        constructor(...args) {
          ...
          this._maskContainer = void 0;
          this._maskContainerUITrans = void 0;
          this._scrollType = void 0;
          this._scrollStep = void 0;
          this._mouseWheelStep = void 0;
          this._decelerationRate = void 0;
          this._scrollBarMargin = void 0;
          this._bouncebackEffect = void 0;
          this._touchEffect = void 0;
          this._scrollBarDisplayAuto = void 0;
          this._vScrollNone = void 0;
          this._hScrollNone = void 0;
          this._needRefresh = void 0;
          this._refreshBarAxis = void 0;
          this._displayOnLeft = void 0;
          this._snapToItem = void 0;
          this._snappingPolicy = void 0;
          this._displayInDemand = void 0;
          this._mouseWheelEnabled = void 0;
          this._pageMode = void 0;
          this._inertiaDisabled = void 0;
          this._floating = void 0;
          this._dontClip = void 0;
          this._dontClipMargin = void 0;
          this._xPos = void 0;
          this._yPos = void 0;
          this._viewSize = void 0;
          this._contentSize = void 0;
          this._overlapSize = void 0;
          this._pageSize = void 0;
          this._containerPos = void 0;
          this._beginTouchPos = void 0;
          this._lastTouchPos = void 0;
          this._lastTouchGlobalPos = void 0;
          this._velocity = void 0;
          this._velocityScale = void 0;
          this._lastMoveTime = void 0;
          this._isHoldAreaDone = void 0;
          this._aniFlag = 0;
          this._loop = void 0;
          this._headerLockedSize = void 0;
          this._footerLockedSize = void 0;
          this._refreshEventDispatching = void 0;
          this._dragged = void 0;
          this._hover = void 0;
          this._tweening = void 0;
          this._tweenTime = void 0;
          this._tweenDuration = void 0;
          this._tweenStart = void 0;
          this._tweenChange = void 0;
          this._pageController = void 0;
          this._hzScrollBar = void 0;
          this._vtScrollBar = void 0;
          this._header = void 0;
          this._footer = void 0;
        }

        setup(buffer) {
          const o = this._owner = (_crd && GObject === void 0 ? (_reportPossibleCrUseOfGObject({
            error: Error()
          }), GObject) : GObject).cast(this.node);
          this._maskContainer = new Node("ScrollPane");
          this._maskContainer.layer = (_crd && UIConfig === void 0 ? (_reportPossibleCrUseOfUIConfig({
            error: Error()
          ...
          this._scrollBarMargin = new (_crd && Margin === void 0 ? (_reportPossibleCrUseOfMargin({
            error: Error()
          }), Margin) : Margin)();
          ...
          this._scrollStep = (_crd && UIConfig === void 0 ? (_reportPossibleCrUseOfUIConfig({
            error: Error()
          }), UIConfig) : UIConfig).defaultScrollStep;
          this._mouseWheelStep = this._scrollStep * 2;
          this._decelerationRate = (_crd && UIConfig === void 0 ? (_reportPossibleCrUseOfUIConfig({
            error: Error()
          }), UIConfig) : UIConfig).defaultScrollDecelerationRate;
          this._snappingPolicy = 0;
          o.on((_crd && FUIEvent === void 0 ? (_reportPossibleCrUseOfFUIEvent({
            error: Error()
          }), FUIEvent) : FUIEvent).TOUCH_BEGIN, this.onTouchBegin, this);
          o.on((_crd && FUIEvent === void 0 ? (_reportPossibleCrUseOfFUIEvent({
            error: Error()
          }), FUIEvent) : FUIEvent).TOUCH_MOVE, this.onTouchMove, this);
          o.on((_crd && FUIEvent === void 0 ? (_reportPossibleCrUseOfFUIEvent({
            error: Error()
          }), FUIEvent) : FUIEvent).TOUCH_END, this.onTouchEnd, this);
          o.on((_crd && FUIEvent === void 0 ? (_reportPossibleCrUseOfFUIEvent({
            error: Error()
          }), FUIEvent) : FUIEvent).MOUSE_WHEEL, this.onMouseWheel, this);
          ...
          if (flags & 16) this._touchEffect = true;else if (flags & 32) this._touchEffect = false;else this._touchEffect = (_crd && UIConfig === void 0 ? (_reportPossibleCrUseOfUIConfig({
            error: Error()
          }), UIConfig) : UIConfig).defaultScrollTouchEffect;
          if (flags & 64) this._bouncebackEffect = true;else if (flags & 128) this._bouncebackEffect = false;else this._bouncebackEffect = (_crd && UIConfig === void 0 ? (_reportPossibleCrUseOfUIConfig({
            error: Error()
          }), UIConfig) : UIConfig).defaultScrollBounceEffect;
          ...
          if (scrollBarDisplay == (_crd && ScrollBarDisplayType === void 0 ? (_reportPossibleCrUseOfScrollBarDisplayType({
            error: Error()
          }), ScrollBarDisplayType) : ScrollBarDisplayType).Default) scrollBarDisplay = (_crd && UIConfig === void 0 ? (_reportPossibleCrUseOfUIConfig({
            error: Error()
          }), UIConfig) : UIConfig).defaultScrollBarDisplay;

          if (scrollBarDisplay != (_crd && ScrollBarDisplayType === void 0 ? (_reportPossibleCrUseOfScrollBarDisplayType({
            error: Error()
          }), ScrollBarDisplayType) : ScrollBarDisplayType).Hidden) {
            if (this._scrollType == (_crd && ScrollType === void 0 ? (_reportPossibleCrUseOfScrollType({
              error: Error()
            }), ScrollType) : ScrollType).Both || this._scrollType == (_crd && ScrollType === void 0 ? (_reportPossibleCrUseOfScrollType({
              error: Error()
            }), ScrollType) : ScrollType).Vertical) {
              var res = vtScrollBarRes ? vtScrollBarRes : (_crd && UIConfig === void 0 ? (_reportPossibleCrUseOfUIConfig({
                error: Error()
              }), UIConfig) : UIConfig).verticalScrollBar;

              if (res) {
                this._vtScrollBar = (_crd && UIPackage === void 0 ? (_reportPossibleCrUseOfUIPackage({
                  error: Error()
                }), UIPackage) : UIPackage).createObjectFromURL(res);
            ...
            if (this._scrollType == (_crd && ScrollType === void 0 ? (_reportPossibleCrUseOfScrollType({
              ...
              var res = hzScrollBarRes ? hzScrollBarRes : (_crd && UIConfig === void 0 ? (_reportPossibleCrUseOfUIConfig({
                error: Error()
              }), UIConfig) : UIConfig).horizontalScrollBar;

              if (res) {
                this._hzScrollBar = (_crd && UIPackage === void 0 ? (_reportPossibleCrUseOfUIPackage({
                  error: Error()
                }), UIPackage) : UIPackage).createObjectFromURL(res);
            ...
            if (scrollBarDisplay == (_crd && ScrollBarDisplayType === void 0 ? (_reportPossibleCrUseOfScrollBarDisplayType({
              error: Error()
            }), ScrollBarDisplayType) : ScrollBarDisplayType).Auto) this._scrollBarDisplayAuto = true;
          ...
          if (headerRes) {
            this._header = (_crd && UIPackage === void 0 ? (_reportPossibleCrUseOfUIPackage({
              error: Error()
            }), UIPackage) : UIPackage).createObjectFromURL(headerRes);
          ...
          if (footerRes) {
            this._footer = (_crd && UIPackage === void 0 ? (_reportPossibleCrUseOfUIPackage({
              error: Error()
            }), UIPackage) : UIPackage).createObjectFromURL(footerRes);
          ...
          this._refreshBarAxis = this._scrollType == (_crd && ScrollType === void 0 ? (_reportPossibleCrUseOfScrollType({
            error: Error()
          }), ScrollType) : ScrollType).Both || this._scrollType == (_crd && ScrollType === void 0 ? (_reportPossibleCrUseOfScrollType({
            error: Error()
          }), ScrollType) : ScrollType).Vertical ? "y" : "x";
        ...
        set scrollStep(val) {
          ...
          if (this._scrollStep == 0) this._scrollStep = (_crd && UIConfig === void 0 ? (_reportPossibleCrUseOfUIConfig({
            error: Error()
          }), UIConfig) : UIConfig).defaultScrollStep;
          this._mouseWheelStep = this._scrollStep * 2;
        }
        ...
        scrollToView(target, ani, setFirst) {
          ...
          if (target instanceof (_crd && GObject === void 0 ? (_reportPossibleCrUseOfGObject({
            error: Error()
          }), GObject) : GObject)) {
        ...
        handleControllerChanged(c) {
          if (this._pageController == c) {
            if (this._scrollType == (_crd && ScrollType === void 0 ? (_reportPossibleCrUseOfScrollType({
              error: Error()
            }), ScrollType) : ScrollType).Horizontal) this.setCurrentPageX(c.selectedIndex, true);else this.setCurrentPageY(c.selectedIndex, true);
          }
        }
        ...
        updatePageController() {
          if (this._pageController && !this._pageController.changing) {
            ...
            if (this._scrollType == (_crd && ScrollType === void 0 ? (_reportPossibleCrUseOfScrollType({
              error: Error()
            }), ScrollType) : ScrollType).Horizontal) index = this.currentPageX;else index = this.currentPageY;
        ...
        handleSizeChanged() {
          ...
          if (this._scrollType == (_crd && ScrollType === void 0 ? (_reportPossibleCrUseOfScrollType({
            error: Error()
          }), ScrollType) : ScrollType).Horizontal || this._scrollType == (_crd && ScrollType === void 0 ? (_reportPossibleCrUseOfScrollType({
            error: Error()
          }), ScrollType) : ScrollType).Both) this._overlapSize.x = Math.ceil(Math.max(0, this._contentSize.x - this._viewSize.x));else this._overlapSize.x = 0;
          if (this._scrollType == (_crd && ScrollType === void 0 ? (_reportPossibleCrUseOfScrollType({
            error: Error()
          }), ScrollType) : ScrollType).Vertical || this._scrollType == (_crd && ScrollType === void 0 ? (_reportPossibleCrUseOfScrollType({
            error: Error()
          }), ScrollType) : ScrollType).Both) this._overlapSize.y = Math.ceil(Math.max(0, this._contentSize.y - this._viewSize.y));else this._overlapSize.y = 0; //边界检查
        ...
        refresh(dt) {
          ...
          this._owner.node.emit((_crd && FUIEvent === void 0 ? (_reportPossibleCrUseOfFUIEvent({
            error: Error()
          }), FUIEvent) : FUIEvent).SCROLL, this._owner);
        ...
        onTouchBegin(evt) {
          ...
          if (this._tweening != 0) {
            ...
            (_crd && Decls === void 0 ? (_reportPossibleCrUseOfDecls({
              error: Error()
            }), Decls) : Decls).GRoot.inst.inputProcessor.cancelClick(evt.touchId);
            this._dragged = true;
        ...
        onTouchMove(evt) {
          ...
          if (!this._touchEffect) return;
          if ((_crd && GObject === void 0 ? (_reportPossibleCrUseOfGObject({
            error: Error()
          }), GObject) : GObject).draggingObject && (_crd && GObject === void 0 ? (_reportPossibleCrUseOfGObject({
            error: Error()
          }), GObject) : GObject).draggingObject.onStage) return;
          ...
          var sensitivity = (_crd && UIConfig === void 0 ? (_reportPossibleCrUseOfUIConfig({
            error: Error()
          }), UIConfig) : UIConfig).touchScrollSensitivity;
          var diff, diff2;
          var sv, sh, st;
          ...
          if (this._scrollType == (_crd && ScrollType === void 0 ? (_reportPossibleCrUseOfScrollType({
            ...
            sv = true;
          } else if (this._scrollType == (_crd && ScrollType === void 0 ? (_reportPossibleCrUseOfScrollType({
            error: Error()
          }), ScrollType) : ScrollType).Horizontal) {
            if (!this._isHoldAreaDone) {
              _gestureFlag |= 2;
        ...
        onTouchEnd(evt) {
          ...
          if (flag) {
            ...
            if (this._tweenChange.x < -(_crd && UIConfig === void 0 ? (_reportPossibleCrUseOfUIConfig({
              error: Error()
            }), UIConfig) : UIConfig).touchDragSensitivity || this._tweenChange.y < -(_crd && UIConfig === void 0 ? (_reportPossibleCrUseOfUIConfig({
              error: Error()
            }), UIConfig) : UIConfig).touchDragSensitivity) {
              this._refreshEventDispatching = true;
              this._owner.node.emit((_crd && FUIEvent === void 0 ? (_reportPossibleCrUseOfFUIEvent({
                error: Error()
              }), FUIEvent) : FUIEvent).PULL_DOWN_RELEASE), this._owner;
              this._refreshEventDispatching = false;
            } else if (this._tweenChange.x > (_crd && UIConfig === void 0 ? (_reportPossibleCrUseOfUIConfig({
              error: Error()
            }), UIConfig) : UIConfig).touchDragSensitivity || this._tweenChange.y > (_crd && UIConfig === void 0 ? (_reportPossibleCrUseOfUIConfig({
              error: Error()
            }), UIConfig) : UIConfig).touchDragSensitivity) {
              ...
              this._owner.node.emit((_crd && FUIEvent === void 0 ? (_reportPossibleCrUseOfFUIEvent({
                error: Error()
              }), FUIEvent) : FUIEvent).PULL_UP_RELEASE, this._owner);
        ...
        updateScrollBarVisible2(bar) {
          if (this._scrollBarDisplayAuto) (_crd && GTween === void 0 ? (_reportPossibleCrUseOfGTween({
            error: Error()
          }), GTween) : GTween).kill(bar, false, "alpha");

          if (this._scrollBarDisplayAuto && !this._hover && this._tweening == 0 && !this._dragged && !bar.gripDragging) {
            if (bar.node.active) (_crd && GTween === void 0 ? (_reportPossibleCrUseOfGTween({
              error: Error()
            }), GTween) : GTween).to(1, 0, 0.5).setDelay(0.5).onComplete(this.__barTweenComplete, this).setTarget(bar, "alpha");
          } else {
            bar.alpha = 1;
        ...
        killTween() {
          ...
          this._owner.node.emit((_crd && FUIEvent === void 0 ? (_reportPossibleCrUseOfFUIEvent({
            error: Error()
          }), FUIEvent) : FUIEvent).SCROLL_END, this._owner);
        }
      ...
      ScrollPane.draggingPane = void 0;
      _gestureFlag = 0;
...
//# sourceMappingURL=d8b95345420556ab27f58e0e15c14ed18d3ef6af.js.map
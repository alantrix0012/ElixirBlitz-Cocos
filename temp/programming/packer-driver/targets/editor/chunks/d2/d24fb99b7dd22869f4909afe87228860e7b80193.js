  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameManager", GameManager = (_dec = ccclass("GameManager"), _dec2 = property(_crd && PotionSpawner === void 0 ? (_reportPossibleCrUseOfPotionSpawner({
        ...
        start() {
          this.setState(GameState.MainMenu); // this.startGame();
        }
        ...
        onScreenClicked() {
          if (this._currentState !== GameState.Playing) return; // this.pot?.handleInput();
        }
        ...
        goToHome() {
          var _this$spawner, _this$pot2;

          (_this$spawner = this.spawner) == null ? void 0 : _this$spawner.resetSpawner();
          (_this$pot2 = this.pot) == null ? void 0 : _this$pot2.resetPot();
          (_crd && ScoreManager === void 0 ? (_reportPossibleCrUseOfScoreManager({
            error: Error()
          }), ScoreManager) : ScoreManager).instance.resetScore();
          this._currentMisses = 0;
...
//# sourceMappingURL=d24fb99b7dd22869f4909afe87228860e7b80193.js.map
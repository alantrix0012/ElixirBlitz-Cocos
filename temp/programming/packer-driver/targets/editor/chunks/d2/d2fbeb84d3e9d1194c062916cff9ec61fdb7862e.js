  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameOverController", GameOverController = class GameOverController extends (_crd && ScreenBase === void 0 ? (_reportPossibleCrUseOfScreenBase({
        ...
        onShow() {
          const scoreText = this.view.getChild("Scorebox").asCom.getChild("Score").asTextField;
          scoreText.text = `SCORE : ${this.scores.getScore()}`;
        }

        init() {
          const homeBtn = this.view.getChild("HomeButton").asButton;
          const retryBtn = this.view.getChild("RetryButton").asButton;
...
//# sourceMappingURL=d2fbeb84d3e9d1194c062916cff9ec61fdb7862e.js.map
System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, FUIEvent, GComponent, GList, GObject, GTreeNode, GTree, _crd, s_list;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      GList = _unresolved_4.GList;
    }, function (_unresolved_5) {
      GObject = _unresolved_5.GObject;
    }, function (_unresolved_6) {
      GTreeNode = _unresolved_6.GTreeNode;
    }],
    execute: function () {
      _crd = true;

      _cclegacy._RF.push({}, "4f9b15oC8FK9aDePV7YKOtw", "GTree", undefined);

      __checkObsolete__(['Node']);

      _export("GTree", GTree = class GTree extends (_crd && GList === void 0 ? (_reportPossibleCrUseOfGList({
        error: Error()
      }), GList) : GList) {
        constructor() {
          super();
          this.treeNodeRender = void 0;
          this.treeNodeWillExpand = void 0;
          this._indent = void 0;
          this._clickToExpand = void 0;
          this._rootNode = void 0;
          this._expandedStatusInEvt = void 0;
          this._indent = 15;
          this._rootNode = new (_crd && GTreeNode === void 0 ? (_reportPossibleCrUseOfGTreeNode({
            error: Error()
          }), GTreeNode) : GTreeNode)(true);
        ...
        createCell(node) {
          ...
          if (!(child instanceof (_crd && GComponent === void 0 ? (_reportPossibleCrUseOfGComponent({
            error: Error()
          }), GComponent) : GComponent))) throw new Error("cannot create tree node object.");
          ...
          if (cc) {
            cc.on((_crd && FUIEvent === void 0 ? (_reportPossibleCrUseOfFUIEvent({
              error: Error()
            }), FUIEvent) : FUIEvent).STATUS_CHANGED, this.__expandedStateChanged, this);
            cc.selectedIndex = node.expanded ? 1 : 0;
          }

          cc = child.getController("leaf");
          if (cc) cc.selectedIndex = node.isFolder ? 0 : 1;
          if (node.isFolder) node._cell.on((_crd && FUIEvent === void 0 ? (_reportPossibleCrUseOfFUIEvent({
            error: Error()
          }), FUIEvent) : FUIEvent).TOUCH_BEGIN, this.__cellMouseDown, this);
        ...
        __cellMouseDown(evt) {
          var node = (_crd && GObject === void 0 ? (_reportPossibleCrUseOfGObject({
            error: Error()
          }), GObject) : GObject).cast(evt.currentTarget)._treeNode;
        ...
        readItems(buffer) {
          ...
          for (i = 0; i < cnt; i++) {
            ...
            var node = new (_crd && GTreeNode === void 0 ? (_reportPossibleCrUseOfGTreeNode({
              error: Error()
            }), GTreeNode) : GTreeNode)(isFolder, str);
            node.expanded = true;
...
//# sourceMappingURL=7ea9f66c15430fdd4adbb37e2f233016650dfecc.js.map
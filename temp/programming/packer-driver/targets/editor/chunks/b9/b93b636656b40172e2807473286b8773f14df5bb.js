System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, math, Vec2, CurveType, GPath, _crd;
  ...
  function _reportPossibleCrUseOfCurveType(extras) {
    _reporterNs.report("CurveType", "./GPathPoint", _context.meta, extras);
  }

  function _reportPossibleCrUseOfGPathPoint(extras) {
    _reporterNs.report("GPathPoint", "./GPathPoint", _context.meta, extras);
  }

  _export("GPath", void 0);
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      CurveType = _unresolved_2.CurveType;
    }],
    execute: function () {
      _crd = true;

      _cclegacy._RF.push({}, "21e8cSg+D9HYpjFgEPrh1lD", "GPath", undefined);

      __checkObsolete__(['math', 'Vec2']);

      _export("GPath", GPath = class GPath {
        constructor() {
          this._segments = void 0;
          this._points = void 0;
          this._fullLength = void 0;
        ...
        create(points) {
          ...
          var splinePoints = [];
          var prev = points[0];
          if (prev.curveType == (_crd && CurveType === void 0 ? (_reportPossibleCrUseOfCurveType({
            error: Error()
          }), CurveType) : CurveType).CRSpline) splinePoints.push(new Vec2(prev.x, prev.y));
          ...
          for (var i = 1; i < cnt; i++) {
            ...
            if (prev.curveType != (_crd && CurveType === void 0 ? (_reportPossibleCrUseOfCurveType({
              ...
              } else if (prev.curveType == (_crd && CurveType === void 0 ? (_reportPossibleCrUseOfCurveType({
                error: Error()
            ...
            if (current.curveType != (_crd && CurveType === void 0 ? (_reportPossibleCrUseOfCurveType({
              error: Error()
            }), CurveType) : CurveType).CRSpline) {
        ...
        createSplineSegment(splinePoints) {
          ...
          cnt += 3;
          var seg = {};
          seg.type = (_crd && CurveType === void 0 ? (_reportPossibleCrUseOfCurveType({
            error: Error()
          }), CurveType) : CurveType).CRSpline;
          seg.ptStart = this._points.length;
          seg.ptCount = cnt;
        ...
        getPointAt(t, result) {
          ...
          if (t == 1) {
            ...
            if (seg.type == (_crd && CurveType === void 0 ? (_reportPossibleCrUseOfCurveType({
              error: Error()
            }), CurveType) : CurveType).Straight) {
              ...
              return result;
            } else if (seg.type == (_crd && CurveType === void 0 ? (_reportPossibleCrUseOfCurveType({
              error: Error()
            }), CurveType) : CurveType).Bezier || seg.type == (_crd && CurveType === void 0 ? (_reportPossibleCrUseOfCurveType({
              error: Error()
            }), CurveType) : CurveType).CubicBezier) return this.onBezierCurve(seg.ptStart, seg.ptCount, t, result);else return this.onCRSplineCurve(seg.ptStart, seg.ptCount, t, result);
          }
          ...
          for (var i = 0; i < cnt; i++) {
            ...
            if (len < 0) {
              ...
              if (seg.type == (_crd && CurveType === void 0 ? (_reportPossibleCrUseOfCurveType({
                ...
                error: Error()
              }), CurveType) : CurveType).CubicBezier) result = this.onBezierCurve(seg.ptStart, seg.ptCount, t, result);else result = this.onCRSplineCurve(seg.ptStart, seg.ptCount, t, result);
        ...
        getPointsInSegment(segmentIndex, t0, t1, points, ts, pointDensity) {
          ...
          if (seg.type == (_crd && CurveType === void 0 ? (_reportPossibleCrUseOfCurveType({
            ...
            if (seg.type == (_crd && CurveType === void 0 ? (_reportPossibleCrUseOfCurveType({
              ...
              error: Error()
            }), CurveType) : CurveType).CubicBezier) func = this.onBezierCurve;else func = this.onCRSplineCurve;
...
//# sourceMappingURL=b93b636656b40172e2807473286b8773f14df5bb.js.map
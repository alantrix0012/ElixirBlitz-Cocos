System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Size, Vec2, Rect, FUIEvent, ListLayoutType, ListSelectionMode, AlignType, VertAlignType, ChildrenRenderOrder, OverflowType, GButton, GComponent, GObject, GObjectPool, UIPackage, GList, _crd, s_n;
  ...
  function _reportPossibleCrUseOfListLayoutType(extras) {
    _reporterNs.report("ListLayoutType", "./FieldTypes", _context.meta, extras);
  }

  function _reportPossibleCrUseOfListSelectionMode(extras) {
    _reporterNs.report("ListSelectionMode", "./FieldTypes", _context.meta, extras);
  }
  ...
  function _reportPossibleCrUseOfGObjectPool(extras) {
    _reporterNs.report("GObjectPool", "./GObjectPool", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      ListLayoutType = _unresolved_3.ListLayoutType;
      ListSelectionMode = _unresolved_3.ListSelectionMode;
      AlignType = _unresolved_3.AlignType;
      VertAlignType = _unresolved_3.VertAlignType;
      ChildrenRenderOrder = _unresolved_3.ChildrenRenderOrder;
      OverflowType = _unresolved_3.OverflowType;
    }, function (_unresolved_4) {
      GButton = _unresolved_4.GButton;
    }, function (_unresolved_5) {
      GComponent = _unresolved_5.GComponent;
    }, function (_unresolved_6) {
      GObject = _unresolved_6.GObject;
    }, function (_unresolved_7) {
      GObjectPool = _unresolved_7.GObjectPool;
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "35f37Yce15Ikri66d4xTgKO", "GList", undefined);

      __checkObsolete__(['Size', 'Vec2', 'Rect', 'Node', 'Constructor']);

      _export("GList", GList = class GList extends (_crd && GComponent === void 0 ? (_reportPossibleCrUseOfGComponent({
        error: Error()
        ...
        constructor() {
          ...
          this._lineGap = 0;
          this._columnGap = 0;
          this._defaultItem = void 0;
          this._autoResizeItem = void 0;
          this._selectionMode = void 0;
          this._align = void 0;
          this._verticalAlign = void 0;
          this._selectionController = void 0;
          this._lastSelectedIndex = 0;
          this._pool = void 0;
          this._virtual = void 0;
          this._loop = void 0;
          this._numItems = 0;
          ...
          this._virtualItems = void 0;
          this._eventLocked = void 0;
          this.itemInfoVer = 0;
          this._node.name = "GList";
          this._trackBounds = true;
          this._pool = new (_crd && GObjectPool === void 0 ? (_reportPossibleCrUseOfGObjectPool({
            error: Error()
          }), GObjectPool) : GObjectPool)();
          this._layout = (_crd && ListLayoutType === void 0 ? (_reportPossibleCrUseOfListLayoutType({
            error: Error()
          }), ListLayoutType) : ListLayoutType).SingleColumn;
          this._autoResizeItem = true;
          this._lastSelectedIndex = -1;
          this._selectionMode = (_crd && ListSelectionMode === void 0 ? (_reportPossibleCrUseOfListSelectionMode({
            error: Error()
        ...
        set defaultItem(val) {
          this._defaultItem = (_crd && UIPackage === void 0 ? (_reportPossibleCrUseOfUIPackage({
            error: Error()
          }), UIPackage) : UIPackage).normalizeURL(val);
        }
        ...
        addChildAt(child, index) {
          ...
          if (child instanceof (_crd && GButton === void 0 ? (_reportPossibleCrUseOfGButton({
            error: Error()
          }), GButton) : GButton)) {
          ...
          child.on((_crd && FUIEvent === void 0 ? (_reportPossibleCrUseOfFUIEvent({
            error: Error()
          }), FUIEvent) : FUIEvent).CLICK, this.onClickItem, this);
          return child;
        }

        addItem(url) {
          if (!url) url = this._defaultItem;
          return this.addChild((_crd && UIPackage === void 0 ? (_reportPossibleCrUseOfUIPackage({
            error: Error()
        ...
        removeChildAt(index, dispose) {
          ...
          if (!dispose) child.off((_crd && FUIEvent === void 0 ? (_reportPossibleCrUseOfFUIEvent({
            error: Error()
          }), FUIEvent) : FUIEvent).CLICK, this.onClickItem, this);
          return child;
        }
        ...
        get selectedIndex() {
          ...
          if (this._virtual) {
            for (i = 0; i < this._realNumItems; i++) {
              ...
              if (ii.obj instanceof (_crd && GButton === void 0 ? (_reportPossibleCrUseOfGButton({
                error: Error()
              }), GButton) : GButton) && ii.obj.selected || !ii.obj && ii.selected) {
            ...
            for (i = 0; i < cnt; i++) {
              ...
              if (obj instanceof (_crd && GButton === void 0 ? (_reportPossibleCrUseOfGButton({
                error: Error()
              }), GButton) : GButton) && obj.selected) return i;
            }
          }
        ...
        set selectedIndex(value) {
          if (value >= 0 && value < this.numItems) {
            if (this._selectionMode != (_crd && ListSelectionMode === void 0 ? (_reportPossibleCrUseOfListSelectionMode({
              error: Error()
            }), ListSelectionMode) : ListSelectionMode).Single) this.clearSelection();
        ...
        getSelection(result) {
          ...
          if (this._virtual) {
            ...
            for (i = 0; i < cnt; i++) {
              ...
              if (obj instanceof (_crd && GButton === void 0 ? (_reportPossibleCrUseOfGButton({
                error: Error()
              }), GButton) : GButton) && obj.selected) result.push(i);
            }
          }
        ...
        addSelection(index, scrollItToView) {
          if (this._selectionMode == (_crd && ListSelectionMode === void 0 ? (_reportPossibleCrUseOfListSelectionMode({
            error: Error()
          }), ListSelectionMode) : ListSelectionMode).None) return;
        ...
        removeSelection(index) {
          ...
          if (obj instanceof (_crd && GButton === void 0 ? (_reportPossibleCrUseOfGButton({
            error: Error()
          }), GButton) : GButton)) obj.selected = false;
        }
        ...
        clearSelection() {
          ...
          if (this._virtual) {
            for (i = 0; i < this._realNumItems; i++) {
              ...
              if (ii.obj instanceof (_crd && GButton === void 0 ? (_reportPossibleCrUseOfGButton({
                error: Error()
              }), GButton) : GButton)) ii.obj.selected = false;
              ii.selected = false;
            }
          } else {
            var cnt = this._children.length;
        ...
        clearSelectionExcept(g) {
          ...
          if (this._virtual) {
            ...
            for (i = 0; i < cnt; i++) {
              ...
              if (obj instanceof (_crd && GButton === void 0 ? (_reportPossibleCrUseOfGButton({
                error: Error()
              }), GButton) : GButton) && obj != g) obj.selected = false;
            }
          }
        }
        ...
        selectAll() {
          ...
          if (this._virtual) {
            for (i = 0; i < this._realNumItems; i++) {
              ...
              if (ii.obj instanceof (_crd && GButton === void 0 ? (_reportPossibleCrUseOfGButton({
                error: Error()
              }), GButton) : GButton) && !ii.obj.selected) {
        ...
        handleArrowKey(dir) {
          ...
          switch (dir) {
            case 1:
              //up
              if (this._layout == (_crd && ListLayoutType === void 0 ? (_reportPossibleCrUseOfListLayoutType({
                error: Error()
              }), ListLayoutType) : ListLayoutType).SingleColumn || this._layout == (_crd && ListLayoutType === void 0 ? (_reportPossibleCrUseOfListLayoutType({
                error: Error()
              }), ListLayoutType) : ListLayoutType).FlowVertical) {
                index--;
              ...
              } else if (this._layout == (_crd && ListLayoutType === void 0 ? (_reportPossibleCrUseOfListLayoutType({
                error: Error()
              }), ListLayoutType) : ListLayoutType).FlowHorizontal || this._layout == (_crd && ListLayoutType === void 0 ? (_reportPossibleCrUseOfListLayoutType({
                error: Error()
              }), ListLayoutType) : ListLayoutType).Pagination) {
            ...
            case 3:
              ...
              if (this._layout == (_crd && ListLayoutType === void 0 ? (_reportPossibleCrUseOfListLayoutType({
                error: Error()
              }), ListLayoutType) : ListLayoutType).SingleRow || this._layout == (_crd && ListLayoutType === void 0 ? (_reportPossibleCrUseOfListLayoutType({
                error: Error()
              }), ListLayoutType) : ListLayoutType).FlowHorizontal || this._layout == (_crd && ListLayoutType === void 0 ? (_reportPossibleCrUseOfListLayoutType({
                error: Error()
              }), ListLayoutType) : ListLayoutType).Pagination) {
        ...
        onClickItem(evt) {
          ...
          var item = (_crd && GObject === void 0 ? (_reportPossibleCrUseOfGObject({
            error: Error()
        ...
        dispatchItemEvent(item, evt) {
          this._node.emit((_crd && FUIEvent === void 0 ? (_reportPossibleCrUseOfFUIEvent({
            error: Error()
          }), FUIEvent) : FUIEvent).CLICK_ITEM, item, evt);
        }

        setSelectionOnEvent(item, evt) {
          if (!(item instanceof (_crd && GButton === void 0 ? (_reportPossibleCrUseOfGButton({
            error: Error()
          }), GButton) : GButton)) || this._selectionMode == (_crd && ListSelectionMode === void 0 ? (_reportPossibleCrUseOfListSelectionMode({
            error: Error()
          }), ListSelectionMode) : ListSelectionMode).None) return;
          ...
          if (this._selectionMode == (_crd && ListSelectionMode === void 0 ? (_reportPossibleCrUseOfListSelectionMode({
                ...
                if (this._lastSelectedIndex != -1) {
                  ...
                  if (this._virtual) {
                    for (i = min; i <= max; i++) {
                      ...
                      if (ii.obj instanceof (_crd && GButton === void 0 ? (_reportPossibleCrUseOfGButton({
                        error: Error()
                      }), GButton) : GButton)) ii.obj.selected = true;
                      ii.selected = true;
                    }
                  } else {
                    for (i = min; i <= max; i++) {
                      ...
                      if (obj instanceof (_crd && GButton === void 0 ? (_reportPossibleCrUseOfGButton({
                        error: Error()
                      }), GButton) : GButton)) obj.selected = true;
                    }
                  }
            ...
            } else if (evt.isCtrlDown || this._selectionMode == (_crd && ListSelectionMode === void 0 ? (_reportPossibleCrUseOfListSelectionMode({
              error: Error()
            }), ListSelectionMode) : ListSelectionMode).Multiple_SingleClick) {
        ...
        resizeToFit(itemCount = Number.POSITIVE_INFINITY, minSize = 0) {
          ...
          if (this._virtual) {
            ...
            if (this._layout == (_crd && ListLayoutType === void 0 ? (_reportPossibleCrUseOfListLayoutType({
              ...
              error: Error()
            }), ListLayoutType) : ListLayoutType).FlowHorizontal) this.viewHeight = lineCount * this._itemSize.height + Math.max(0, lineCount - 1) * this._lineGap;else this.viewWidth = lineCount * this._itemSize.width + Math.max(0, lineCount - 1) * this._columnGap;
          } else if (itemCount == 0) {
            if (this._layout == (_crd && ListLayoutType === void 0 ? (_reportPossibleCrUseOfListLayoutType({
              error: Error()
            }), ListLayoutType) : ListLayoutType).SingleColumn || this._layout == (_crd && ListLayoutType === void 0 ? (_reportPossibleCrUseOfListLayoutType({
              error: Error()
            }), ListLayoutType) : ListLayoutType).FlowHorizontal) this.viewHeight = minSize;else this.viewWidth = minSize;
          } else {
            var i = itemCount - 1;
            var obj = null;
            ...
            if (i < 0) {
              ...
              if (this._layout == (_crd && ListLayoutType === void 0 ? (_reportPossibleCrUseOfListLayoutType({
                ...
                error: Error()
              }), ListLayoutType) : ListLayoutType).FlowHorizontal) {
          ...
          if (!this._virtual) {
            ...
            if (loop) {
              if (this._layout == (_crd && ListLayoutType === void 0 ? (_reportPossibleCrUseOfListLayoutType({
                ...
                error: Error()
              }), ListLayoutType) : ListLayoutType).FlowVertical) throw new Error("Loop list is not supported for FlowHorizontal or FlowVertical layout!");
            ...
            this._node.on((_crd && FUIEvent === void 0 ? (_reportPossibleCrUseOfFUIEvent({
              error: Error()
            }), FUIEvent) : FUIEvent).SCROLL, this.__scrolled, this);
        ...
        _refreshVirtualList(dt) {
          if (!isNaN(dt)) {
            let _t = (_crd && GObject === void 0 ? (_reportPossibleCrUseOfGObject({
              error: Error()
          ...
          if (layoutChanged) {
            if (this._layout == (_crd && ListLayoutType === void 0 ? (_reportPossibleCrUseOfListLayoutType({
              ...
              error: Error()
            }), ListLayoutType) : ListLayoutType).SingleRow) this._curLineItemCount = 1;else if (this._layout == (_crd && ListLayoutType === void 0 ? (_reportPossibleCrUseOfListLayoutType({
              error: Error()
            }), ListLayoutType) : ListLayoutType).FlowHorizontal) {
          ...
          while (curIndex < this._realNumItems && (end || curY < max)) {
            ...
            if (!ii.obj || forceUpdate) {
              ...
              if (ii.obj && ii.obj.resourceURL != url) {
                if (ii.obj instanceof (_crd && GButton === void 0 ? (_reportPossibleCrUseOfGButton({
                  error: Error()
                }), GButton) : GButton)) ii.selected = ii.obj.selected;
            ...
            if (!ii.obj) {
              ...
              if (forward) {
                for (j = reuseIndex; j >= oldFirstIndex; j--) {
                  ...
                  if (ii2.obj && ii2.updateFlag != this.itemInfoVer && ii2.obj.resourceURL == url) {
                    if (ii2.obj instanceof (_crd && GButton === void 0 ? (_reportPossibleCrUseOfGButton({
                      error: Error()
                    }), GButton) : GButton)) ii2.selected = ii2.obj.selected;
                    ii.obj = ii2.obj;
                    ii2.obj = null;
              ...
              if (ii.obj instanceof (_crd && GButton === void 0 ? (_reportPossibleCrUseOfGButton({
                error: Error()
              }), GButton) : GButton)) ii.obj.selected = ii.selected;
              needRender = true;
            } else needRender = forceUpdate;

            if (needRender) {
              if (this._autoResizeItem && (this._layout == (_crd && ListLayoutType === void 0 ? (_reportPossibleCrUseOfListLayoutType({
                error: Error()
              }), ListLayoutType) : ListLayoutType).SingleColumn || this._columnCount > 0)) ii.obj.setSize(partSize, ii.obj.height, true);
        ...
        handleScroll2(forceUpdate) {
          ...
          while (curIndex < this._realNumItems && (end || curX < max)) {
            ...
            if (needRender) {
              if (this._autoResizeItem && (this._layout == (_crd && ListLayoutType === void 0 ? (_reportPossibleCrUseOfListLayoutType({
                error: Error()
              }), ListLayoutType) : ListLayoutType).SingleRow || this._lineCount > 0)) ii.obj.setSize(ii.obj.width, partSize, true);
              this.itemRenderer(curIndex % this._numItems, ii.obj);
        ...
        handleAlign(contentWidth, contentHeight) {
          ...
          if (contentHeight < this.viewHeight) {
            if (this._verticalAlign == (_crd && VertAlignType === void 0 ? (_reportPossibleCrUseOfVertAlignType({
              error: Error()
            }), VertAlignType) : VertAlignType).Middle) newOffsetY = Math.floor((this.viewHeight - contentHeight) / 2);else if (this._verticalAlign == (_crd && VertAlignType === void 0 ? (_reportPossibleCrUseOfVertAlignType({
              error: Error()
            }), VertAlignType) : VertAlignType).Bottom) newOffsetY = this.viewHeight - contentHeight;
          }

          if (contentWidth < this.viewWidth) {
            if (this._align == (_crd && AlignType === void 0 ? (_reportPossibleCrUseOfAlignType({
              error: Error()
            }), AlignType) : AlignType).Center) newOffsetX = Math.floor((this.viewWidth - contentWidth) / 2);else if (this._align == (_crd && AlignType === void 0 ? (_reportPossibleCrUseOfAlignType({
              error: Error()
            }), AlignType) : AlignType).Right) newOffsetX = this.viewWidth - contentWidth;
          }
        ...
        updateBounds() {
          ...
          if (this._layout == (_crd && ListLayoutType === void 0 ? (_reportPossibleCrUseOfListLayoutType({
            ...
            error: Error()
          }), ListLayoutType) : ListLayoutType).SingleRow) {
            for (i = 0; i < cnt; i++) {
              child = this.getChildAt(i);
              if (this.foldInvisibleItems && !child.visible) continue;
        ...
        setupItem(buffer, obj) {
          ...
          str = buffer.readS();
          if (str != null && obj instanceof (_crd && GButton === void 0 ? (_reportPossibleCrUseOfGButton({
            error: Error()
          }), GButton) : GButton)) obj.selectedTitle = str;
          str = buffer.readS();
          if (str != null) obj.icon = str;
          str = buffer.readS();
          if (str != null && obj instanceof (_crd && GButton === void 0 ? (_reportPossibleCrUseOfGButton({
            error: Error()
          }), GButton) : GButton)) obj.selectedIcon = str;
          str = buffer.readS();
...
//# sourceMappingURL=51b2f3cc9d526fbad3bbb3a1651a51813f380fe6.js.map
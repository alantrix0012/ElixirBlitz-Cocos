    ...
    execute: function () {
      ...
      _export("InputProcessor", InputProcessor = class InputProcessor extends Component {
        ...
        touchBeginHandler(evt) {
          ...
          let evt2 = this.getEvent(ti, ti.target, (_crd && FUIEvent === void 0 ? (_reportPossibleCrUseOfFUIEvent({
            error: Error()
          }), FUIEvent) : FUIEvent).TOUCH_BEGIN, true);
        ...
        handleRollOver(ti, target) {
          ...
          for (let i = 0; i < cnt; i++) {
            ...
            if (element.node && element.node.activeInHierarchy) {
              let evt = this.getEvent(ti, element, (_crd && FUIEvent === void 0 ? (_reportPossibleCrUseOfFUIEvent({
                error: Error()
        ...
        getEvent(ti, target, type, bubbles) {
          let evt = (_crd && borrowEvent === void 0 ? (_reportPossibleCrUseOfborrowEvent({
            error: Error()
...
//# sourceMappingURL=70d6a72febc105e9afdcdea28b15f5093763843e.js.map
System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Asset, assetManager, Color, ImageAsset, isValid, Node, resources, Sprite, SpriteFrame, Texture2D, UITransform, MovieClip, AlignType, VertAlignType, LoaderFillType, PackageItemType, ObjectPropID, GComponent, GObject, GObjectPool, UIConfig, UIPackage, GLoader, _crd;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      LoaderFillType = _unresolved_3.LoaderFillType;
      PackageItemType = _unresolved_3.PackageItemType;
      ...
      GObjectPool = _unresolved_6.GObjectPool;
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "20db3/pTVZA9L0heTHWNNg9", "GLoader", undefined);

      __checkObsolete__(['Asset', 'assetManager', 'Color', 'ImageAsset', 'isValid', 'Node', 'resources', 'Sprite', 'SpriteFrame', 'Texture2D', 'UITransform', 'Vec2']);

      _export("GLoader", GLoader = class GLoader extends (_crd && GObject === void 0 ? (_reportPossibleCrUseOfGObject({
        error: Error()
      }), GObject) : GObject) {
        constructor() {
          super();
          ...
          this._showErrorSign = void 0;
          this._playing = void 0;
          this._frame = 0;
          this._color = void 0;
          this._contentItem = void 0;
          this._container = void 0;
          this._errorSign = void 0;
          this._content2 = void 0;
          this._updatingLayout = void 0;
          this._assetBundle = void 0;
          ...
          this._content = this._container.addComponent(_crd && MovieClip === void 0 ? (_reportPossibleCrUseOfMovieClip({
            error: Error()
          }), MovieClip) : MovieClip);
        ...
        get bundle() {
          ...
          return (_crd && UIConfig === void 0 ? (_reportPossibleCrUseOfUIConfig({
            error: Error()
          }), UIConfig) : UIConfig).loaderAssetsBundleName;
        }
        ...
        set playing(value) {
          if (this._playing != value) {
            this._playing = value;
            if (this._content instanceof (_crd && MovieClip === void 0 ? (_reportPossibleCrUseOfMovieClip({
              error: Error()
            }), MovieClip) : MovieClip)) this._content.playing = value;
            this.updateGear(5);
          }
        }
        ...
        set frame(value) {
          if (this._frame != value) {
            ...
            if (this._content instanceof (_crd && MovieClip === void 0 ? (_reportPossibleCrUseOfMovieClip({
              error: Error()
            }), MovieClip) : MovieClip)) this._content.frame = value;
            this.updateGear(5);
          }
        }
        ...
        loadFromPackage(itemURL) {
          let contentItem = (_crd && UIPackage === void 0 ? (_reportPossibleCrUseOfUIPackage({
            error: Error()
          ...
          if (contentItem.type == (_crd && PackageItemType === void 0 ? (_reportPossibleCrUseOfPackageItemType({
            error: Error()
          ...
          } else if (contentItem.type == (_crd && PackageItemType === void 0 ? (_reportPossibleCrUseOfPackageItemType({
            error: Error()
            ...
            var obj = (_crd && UIPackage === void 0 ? (_reportPossibleCrUseOfUIPackage({
              error: Error()
            }), UIPackage) : UIPackage).createObjectFromURL(itemURL);
            if (!obj) this.setErrorState();else if (!(obj instanceof (_crd && GComponent === void 0 ? (_reportPossibleCrUseOfGComponent({
              error: Error()
        ...
        setErrorState() {
          ...
          if (this._errorSign == null) {
            if ((_crd && UIConfig === void 0 ? (_reportPossibleCrUseOfUIConfig({
              error: Error()
            }), UIConfig) : UIConfig).loaderErrorSign != null) {
              this._errorSign = GLoader._errorSignPool.getObject((_crd && UIConfig === void 0 ? (_reportPossibleCrUseOfUIConfig({
                error: Error()
              }), UIConfig) : UIConfig).loaderErrorSign);
            }
          }
      ...
      GLoader._errorSignPool = new (_crd && GObjectPool === void 0 ? (_reportPossibleCrUseOfGObjectPool({
        error: Error()
...
//# sourceMappingURL=c26aeda254b85ea9eb579b1b22aacb19ff98f9f1.js.map
System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Color, ObjectPropID, Decls, EaseType, GPath, GPathPoint, CurveType, GTween, UIPackage, Transition, Item, TweenConfig, _crd, OPTION_IGNORE_DISPLAY_CONTROLLER, OPTION_AUTO_STOP_DISABLED, OPTION_AUTO_STOP_AT_END, ActionType;
  ...
  function _reportPossibleCrUseOfGPath(extras) {
    _reporterNs.report("GPath", "./tween/GPath", _context.meta, extras);
  }

  function _reportPossibleCrUseOfGPathPoint(extras) {
    _reporterNs.report("GPathPoint", "./tween/GPathPoint", _context.meta, extras);
  }

  function _reportPossibleCrUseOfCurveType(extras) {
    _reporterNs.report("CurveType", "./tween/GPathPoint", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      Decls = _unresolved_3.Decls;
    }, function (_unresolved_4) {
      EaseType = _unresolved_4.EaseType;
    }, function (_unresolved_5) {
      GPath = _unresolved_5.GPath;
    }, function (_unresolved_6) {
      GPathPoint = _unresolved_6.GPathPoint;
      CurveType = _unresolved_6.CurveType;
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "37697ls4JNGSopj2U6L4a/D", "Transition", undefined);

      __checkObsolete__(['Color', 'AudioClip']);
      ...
      _export("Transition", Transition = class Transition {
        ...
        _play(onComplete, times, delay, startTime, endTime, reversed) {
          ...
          if (delay == 0) this.onDelayedPlay();else (_crd && GTween === void 0 ? (_reportPossibleCrUseOfGTween({
            error: Error()
          }), GTween) : GTween).delayedCall(delay).setTarget(this).onComplete(this.onDelayedPlay, this);
        }
        ...
        stop(setToComplete, processCallback) {
          ...
          (_crd && GTween === void 0 ? (_reportPossibleCrUseOfGTween({
            error: Error()
          }), GTween) : GTween).kill(this); //delay start
        ...
        setPaused(paused) {
          ...
          for (var i = 0; i < cnt; i++) {
            ...
            if (item.type == ActionType.Transition) {
              ...
              if (paused) {
                item.value.flag = item.target.getProp((_crd && ObjectPropID === void 0 ? (_reportPossibleCrUseOfObjectPropID({
                  error: Error()
                }), ObjectPropID) : ObjectPropID).Playing);
                item.target.setProp((_crd && ObjectPropID === void 0 ? (_reportPossibleCrUseOfObjectPropID({
                  error: Error()
                }), ObjectPropID) : ObjectPropID).Playing, false);
              } else item.target.setProp((_crd && ObjectPropID === void 0 ? (_reportPossibleCrUseOfObjectPropID({
                error: Error()
              }), ObjectPropID) : ObjectPropID).Playing, item.value.flag);
            }
        ...
        dispose() {
          if (this._playing) (_crd && GTween === void 0 ? (_reportPossibleCrUseOfGTween({
            error: Error()
          }), GTween) : GTween).kill(this); //delay start
            ...
            if (this._playing) {
              ...
              for (var i = 0; i < cnt; i++) {
                ...
                if (item.tweener) item.tweener.setTimeScale(value);else if (item.type == ActionType.Transition) {
                  ...
                  if (item.target) item.target.setProp((_crd && ObjectPropID === void 0 ? (_reportPossibleCrUseOfObjectPropID({
                    error: Error()
                  }), ObjectPropID) : ObjectPropID).TimeScale, value);
                }
              }
            }
          }
          ...
          if (item.tweenConfig) {
            ...
            if (this._endTime == -1 || time <= this._endTime) {
              ...
              switch (item.type) {
                ...
                case ActionType.Scale:
                case ActionType.Skew:
                  item.tweener = (_crd && GTween === void 0 ? (_reportPossibleCrUseOfGTween({
                    error: Error()
                  }), GTween) : GTween).to2(startValue.f1, startValue.f2, endValue.f1, endValue.f2, item.tweenConfig.duration);
                  break;
                ...
                case ActionType.Rotation:
                  item.tweener = (_crd && GTween === void 0 ? (_reportPossibleCrUseOfGTween({
                    error: Error()
                  }), GTween) : GTween).to(startValue.f1, endValue.f1, item.tweenConfig.duration);
                  break;

                case ActionType.Color:
                  item.tweener = (_crd && GTween === void 0 ? (_reportPossibleCrUseOfGTween({
                    error: Error()
                  }), GTween) : GTween).toColor(startValue.f1, endValue.f1, item.tweenConfig.duration);
                  break;

                case ActionType.ColorFilter:
                  item.tweener = (_crd && GTween === void 0 ? (_reportPossibleCrUseOfGTween({
                    error: Error()
                  }), GTween) : GTween).to4(startValue.f1, startValue.f2, startValue.f3, startValue.f4, endValue.f1, endValue.f2, endValue.f3, endValue.f4, item.tweenConfig.duration);
                  break;
              }
            ...
            item.tweener = (_crd && GTween === void 0 ? (_reportPossibleCrUseOfGTween({
              error: Error()
            }), GTween) : GTween).shake(0, 0, item.value.amplitude, item.value.duration).setDelay(time).setTimeScale(this._timeScale).setTarget(item).onUpdate(this.onTweenUpdate, this).onComplete(this.onTweenComplete, this);
            ...
            if (time <= this._startTime) {
              ...
              item.tweener = (_crd && GTween === void 0 ? (_reportPossibleCrUseOfGTween({
                error: Error()
              }), GTween) : GTween).delayedCall(time).setTimeScale(this._timeScale).setTarget(item).onComplete(this.onDelayedPlayItem, this);
            }
          }
        ...
        skipAnimations() {
          ...
          for (var i = 0; i < cnt; i++) {
            ...
            target = item.target;
            frame = target.getProp((_crd && ObjectPropID === void 0 ? (_reportPossibleCrUseOfObjectPropID({
              error: Error()
            }), ObjectPropID) : ObjectPropID).Frame);
            playStartTime = target.getProp((_crd && ObjectPropID === void 0 ? (_reportPossibleCrUseOfObjectPropID({
              error: Error()
            }), ObjectPropID) : ObjectPropID).Playing) ? 0 : -1;
            playTotalTime = 0;
            ...
            target.setProp((_crd && ObjectPropID === void 0 ? (_reportPossibleCrUseOfObjectPropID({
              error: Error()
            }), ObjectPropID) : ObjectPropID).Playing, playStartTime >= 0);
            target.setProp((_crd && ObjectPropID === void 0 ? (_reportPossibleCrUseOfObjectPropID({
              error: Error()
            }), ObjectPropID) : ObjectPropID).Frame, frame);
            if (playTotalTime > 0) target.setProp((_crd && ObjectPropID === void 0 ? (_reportPossibleCrUseOfObjectPropID({
              error: Error()
            }), ObjectPropID) : ObjectPropID).DeltaTime, playTotalTime);
          }
        }
        ...
        checkAllComplete() {
          if (this._playing && this._totalTasks == 0) {
            if (this._totalTimes < 0) {
              this.internalPlay();
              if (this._totalTasks == 0) (_crd && GTween === void 0 ? (_reportPossibleCrUseOfGTween({
                error: Error()
              }), GTween) : GTween).delayedCall(0).setTarget(this).onComplete(this.checkAllComplete, this);
            } else {
              this._totalTimes--;
        ...
        applyValue(item) {
          ...
          switch (item.type) {
            ...
            case ActionType.Color:
              let color = item.target.getProp((_crd && ObjectPropID === void 0 ? (_reportPossibleCrUseOfObjectPropID({
                error: Error()
              ...
              if (color instanceof Color) {
                ...
                item.target.setProp((_crd && ObjectPropID === void 0 ? (_reportPossibleCrUseOfObjectPropID({
                  error: Error()
                }), ObjectPropID) : ObjectPropID).Color, color);
              }

              break;

            case ActionType.Animation:
              if (value.frame >= 0) item.target.setProp((_crd && ObjectPropID === void 0 ? (_reportPossibleCrUseOfObjectPropID({
                error: Error()
              }), ObjectPropID) : ObjectPropID).Frame, value.frame);
              item.target.setProp((_crd && ObjectPropID === void 0 ? (_reportPossibleCrUseOfObjectPropID({
                error: Error()
              }), ObjectPropID) : ObjectPropID).Playing, value.playing);
              item.target.setProp((_crd && ObjectPropID === void 0 ? (_reportPossibleCrUseOfObjectPropID({
                error: Error()
              }), ObjectPropID) : ObjectPropID).TimeScale, this._timeScale);
              break;
              ...
              if (this._playing && item.time >= this._startTime) {
                if (value.audioClip == null) {
                  var pi = (_crd && UIPackage === void 0 ? (_reportPossibleCrUseOfUIPackage({
                    error: Error()
                  }), UIPackage) : UIPackage).getItemByURL(value.sound);
                  if (pi) value.audioClip = pi.owner.getItemAsset(pi);
                }

                if (value.audioClip) (_crd && Decls === void 0 ? (_reportPossibleCrUseOfDecls({
                  error: Error()
                }), Decls) : Decls).GRoot.inst.playOneShotSound(value.audioClip, value.volume);
              }
          ...
          for (var i = 0; i < cnt; i++) {
            ...
            if (buffer.readBool()) {
              ...
              if (buffer.version >= 2) {
                ...
                if (pathLen > 0) {
                  item.tweenConfig.path = new (_crd && GPath === void 0 ? (_reportPossibleCrUseOfGPath({
                    error: Error()
                  }), GPath) : GPath)();
                  var pts = new Array();
                  ...
                  for (var j = 0; j < pathLen; j++) {
                    ...
                    switch (curveType) {
                      case (_crd && CurveType === void 0 ? (_reportPossibleCrUseOfCurveType({
                        error: Error()
                      }), CurveType) : CurveType).Bezier:
                        pts.push((_crd && GPathPoint === void 0 ? (_reportPossibleCrUseOfGPathPoint({
                          error: Error()
                        }), GPathPoint) : GPathPoint).newBezierPoint(buffer.readFloat(), buffer.readFloat(), buffer.readFloat(), buffer.readFloat()));
                        break;
                      ...
                      case (_crd && CurveType === void 0 ? (_reportPossibleCrUseOfCurveType({
                        ...
                        pts.push((_crd && GPathPoint === void 0 ? (_reportPossibleCrUseOfGPathPoint({
                          error: Error()
                        }), GPathPoint) : GPathPoint).newCubicBezierPoint(buffer.readFloat(), buffer.readFloat(), buffer.readFloat(), buffer.readFloat(), buffer.readFloat(), buffer.readFloat()));
                        break;

                      default:
                        pts.push((_crd && GPathPoint === void 0 ? (_reportPossibleCrUseOfGPathPoint({
                          error: Error()
                        }), GPathPoint) : GPathPoint).newPoint(buffer.readFloat(), buffer.readFloat(), curveType));
                        break;
                    }
                  }
      ...
      ActionType = /*#__PURE__*/function (ActionType) {
      ...
      Item = class Item {
        constructor(type) {
          ...
          this.type = void 0;
          this.tweenConfig = void 0;
          this.label = void 0;
          this.value = void 0;
          this.hook = void 0;
          this.tweener = void 0;
          this.target = void 0;
          this.displayLockToken = void 0;
          this.type = type;
          this.value = {};
...
//# sourceMappingURL=bd87786e368f5d7befd25ffc14044beac578463a.js.map
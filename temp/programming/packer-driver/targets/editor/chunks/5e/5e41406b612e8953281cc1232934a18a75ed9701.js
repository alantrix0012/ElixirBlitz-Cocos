  ...
  return {
    ...
    execute: function () {
      ...
      _export("PotionSpawner", PotionSpawner = (_dec3 = ccclass("PotionSpawner"), _dec4 = property([WeightedPotionType]), _dec3(_class4 = (_class5 = class PotionSpawner extends Component {
        ...
        start() {
          console.log("PotionSpawner started with the following weighted types:");
        }
        ...
        createPools() {
          for (const type of this.weightedTypes) {
            ...
            type.pool = [];
            console.log(`Creating pool for ${(_type$prefab = type.prefab) == null ? void 0 : _type$prefab.name} with size ${this.poolSizePerType}`);
...
//# sourceMappingURL=5e41406b612e8953281cc1232934a18a75ed9701.js.map
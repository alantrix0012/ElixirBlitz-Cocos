System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, GroupLayoutType, GObject, GGroup, _crd;

  function _reportPossibleCrUseOfGroupLayoutType(extras) {
    _reporterNs.report("GroupLayoutType", "./FieldTypes", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      GroupLayoutType = _unresolved_2.GroupLayoutType;
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "bd267i3+YNPYrkTzQ9DtLLc", "GGroup", undefined);

      _export("GGroup", GGroup = class GGroup extends (_crd && GObject === void 0 ? (_reportPossibleCrUseOfGObject({
        error: Error()
      }), GObject) : GObject) {
        constructor() {
          super();
          ...
          this._lineGap = 0;
          this._columnGap = 0;
          this._excludeInvisibles = void 0;
          this._autoSizeDisabled = void 0;
          this._mainGridIndex = -1;
          this._mainGridMinSize = 50;
          this._boundsChanged = void 0;
          this._percentReady = void 0;
        ...
        setBoundsChangedFlag(positionChangedOnly = false) {
          if (this._updating == 0 && this._parent) {
            ...
            if (!this._boundsChanged) {
              ...
              if (this._layout != (_crd && GroupLayoutType === void 0 ? (_reportPossibleCrUseOfGroupLayoutType({
                error: Error()
              }), GroupLayoutType) : GroupLayoutType).None) this._partner.callLater(this._ensureBoundsCorrect);
            }
          }
        }
        ...
        handleLayout() {
          ...
          if (this._layout == (_crd && GroupLayoutType === void 0 ? (_reportPossibleCrUseOfGroupLayoutType({
            error: Error()
          }), GroupLayoutType) : GroupLayoutType).Horizontal) {
            var curX = this.x;
          ...
          } else if (this._layout == (_crd && GroupLayoutType === void 0 ? (_reportPossibleCrUseOfGroupLayoutType({
            error: Error()
          }), GroupLayoutType) : GroupLayoutType).Vertical) {
            var curY = this.y;
            cnt = this._parent.numChildren;
        ...
        resizeChildren(dw, dh) {
          if (this._layout == (_crd && GroupLayoutType === void 0 ? (_reportPossibleCrUseOfGroupLayoutType({
            error: Error()
          }), GroupLayoutType) : GroupLayoutType).None || (this._updating & 2) != 0 || this._parent == null) return;
          this._updating |= 2;
...
//# sourceMappingURL=40bf4cc8079ebfe173ffc1aa60dfb9769f73de7d.js.map
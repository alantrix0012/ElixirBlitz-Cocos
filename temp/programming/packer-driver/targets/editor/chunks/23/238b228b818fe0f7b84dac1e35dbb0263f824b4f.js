  ...
  return {
    ...
    execute: function () {
      ...
      _export("PausePanelController", PausePanelController = class PausePanelController extends (_crd && ScreenBase === void 0 ? (_reportPossibleCrUseOfScreenBase({
        ...
        init() {
          const playButton = this.popup.getChild("PlayButton").asButton;
          const homeButton = this.popup.getChild("HomeButton").asButton;
          const retryButton = this.popup.getChild("RetryButton").asButton;
...
//# sourceMappingURL=238b228b818fe0f7b84dac1e35dbb0263f824b4f.js.map
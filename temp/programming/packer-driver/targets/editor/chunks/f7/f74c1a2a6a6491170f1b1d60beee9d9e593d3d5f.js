System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Prefab, instantiate, Vec3, view, Node, Potion, GameManager, GameState, _dec, _dec2, _class, _class2, _descriptor, _descriptor2, _dec3, _dec4, _dec5, _class4, _class5, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _crd, ccclass, property, WeightedPotionType, PotionSpawner;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Prefab', 'instantiate', 'Vec3', 'view', 'Node']);
      ...
      _export("PotionSpawner", PotionSpawner = (_dec3 = ccclass("PotionSpawner"), _dec4 = property([WeightedPotionType]), _dec5 = property(Node), _dec3(_class4 = (_class5 = class PotionSpawner extends Component {
        constructor(...args) {
          super(...args);
          ...
          _initializerDefineProperty(this, "canvasNode", _descriptor9, this);
        ...
        createPools() {
          for (const type of this.weightedTypes) {
            ...
            for (let i = 0; i < this.poolSizePerType; i += 1) {
              ...
              const potion = node.getComponent(_crd && Potion === void 0 ? (_reportPossibleCrUseOfPotion({
                error: Error()
              }), Potion) : Potion);
              if (!potion) continue;
        ...
        spawnPotion() {
          ...
          console.log(`Spawning potion ${potion.node.name} of type ${potion.potionType} in lane ${lane} with speed bonus ${this.currentSpeedBonus}`);
        ...
        getWeightedPotionType() {
          const totalWeight = this.weightedTypes.reduce((s, t) => s + t.spawnPercentage, 0);
      ...
      }), _descriptor9 = _applyDecoratedDescriptor(_class5.prototype, "canvasNode", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
//# sourceMappingURL=f74c1a2a6a6491170f1b1d60beee9d9e593d3d5f.js.map
    ...
    execute: function () {
      ...
      _export("Potion", Potion = (_dec = ccclass("Potion"), _dec(_class = (_class2 = class Potion extends Component {
        constructor(...args) {
          ...
          _initializerDefineProperty(this, "baseSpeed", _descriptor, this);
        ...
        onLoad() {
          ...
          console.log(`Potion ${this.node.name} of type ${this.potionType} loaded with base speed ${this.baseSpeed}`);
        }
      ...
      }, (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "baseSpeed", [property], {
        configurable: true,
        enumerable: true,
        writable: true,
...
//# sourceMappingURL=257ea182c38fa7fe2a5710e5a70a141be0035d90.js.map